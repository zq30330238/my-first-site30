...
SITE_CONFIG = {
    ...
    "sub-career": {
        ...
        "domain": "career.jycsd.com",
        "category": "Career",
        "brandColor": "blue-600",
        "brandHex": "#2563EB",
        "tailwindColors": """brand: {50: '#eff6ff', 100: '#dbeafe', 200: '#bfdbfe', 400: '#60a5fa', 500: '#3b82f6', 600: '#2563eb', 700: '#1d4ed8', 800: '#1e40af'}""",
        "fontHeading": "'Georgia', 'Times New Roman', 'serif'",
        "blockquoteColor": "#2563eb",
        "blockquoteBg": "#eff6ff",
        "related_articles": [],
    },
    "sub-beauty": {
        ...
        "brandColor": "pink-500",
        "brandHex": "#EC4899",
        "tailwindColors": """brand: {50: '#fdf2f8', 100: '#fce7f3', 200: '#fbcfe8', 400: '#f472b6', 500: '#ec4899', 600: '#db2777', 700: '#be185d', 800: '#9d174d'}""",
        "fontHeading": "'Georgia', 'Times New Roman', 'serif'",
        "blockquoteColor": "#EC4899",
        "blockquoteBg": "#FDF2F8",
        "related_articles": [],
        "predefined_topics": [
            # === Skincare Basics (6 topics) ===
            {"title": "How to Identify Your Skin Type and Build the Right Routine", "category": "skincare", "angle": "beginner diagnostic guide", "key_points": ["5 skin types explained with self-test methods", "Morning vs evening routine differences by skin type", "Product layering order: cleanser, toner, serum, moisturizer, SPF", "Signs your routine is working vs irritating your skin"]},
            {"title": "Double Cleansing Explained: Why It Transforms Your Skincare Results", "category": "skincare", "angle": "technique deep dive", "key_points": ["Oil-based vs water-based cleansers: what each removes", "Step-by-step double cleanse tutorial with product recommendations", "How double cleansing prevents breakouts and improves absorption", "Common mistakes: over-cleansing, wrong oil cleanser for your skin type"]},
            {"title": "Sunscreen 101: SPF, PA Ratings, Mineral vs Chemical, and How Much to Apply", "category": "skincare", "angle": "complete sunscreen education", "key_points": ["SPF and PA rating systems explained with protection levels", "Mineral (zinc oxide, titanium dioxide) vs chemical filters compared", "The 2-finger rule: exactly how much sunscreen to apply", "Reapplication guide: when, how often, and over makeup"]},
            {"title": "The Skin Barrier: How to Protect It and Fix Damage in 14 Days", "category": "skincare", "angle": "repair protocol guide", "key_points": ["What the moisture barrier is and how it gets damaged", "7 signs of a compromised barrier: stinging, redness, tightness", "14-day barrier repair protocol with product suggestions", "Ingredients to avoid during barrier recovery"]},
            {"title": "Exfoliation Guide: AHAs, BHAs, PHAs and How Often to Use Each", "category": "skincare", "angle": "exfoliant comparison", "key_points": ["Chemical vs physical exfoliation: which is better for your skin", "AHAs (glycolic, lactic) vs BHAs (salicylic) vs PHAs: target concerns", "Exfoliation frequency by skin type: over-exfoliation warning signs", "Best exfoliant products at drugstore, mid-range, and luxury prices"]},
            {"title": "How to Layer Skincare Products in the Right Order for Maximum Results", "category": "skincare", "angle": "routine optimization", "key_points": ["The golden rule: thinnest to thickest consistency explained", "AM routine order: cleanser, toner, serum, eye cream, moisturizer, SPF", "PM routine order: double cleanse, toner, treatment, serum, moisturizer, oil", "Wait times between layers: which ones actually matter"]},
            # === Anti-Aging (6 topics) ===
            {"title": "Retinol for Beginners: How to Start Without Irritation and See Real Results", "category": "antiaging", "angle": "beginner retinoid protocol", "key_points": ["Retinol, retinal, tretinoin, adapalene differences explained", "The 1-2-3 method: start once a week, buffer with moisturizer, increase slowly", "Purging vs irritation: how to tell the difference", "Expected timeline: 4 weeks, 8 weeks, 12 weeks, 6 months milestones"]},
            {"title": "Peptides in Skincare: What They Do, Types Compared, and Best Products 2026", "category": "antiaging", "angle": "ingredient analysis", "key_points": ["Signal peptides, carrier peptides, enzyme-inhibitor peptides explained", "Copper peptides: benefits, myths, and formulation compatibility", "Clinical studies on peptide efficacy for collagen production", "Best peptide serums ranked by formulation quality not marketing"]},
            {"title": "Vitamin C Serum Guide: L-Ascorbic Acid vs Derivatives and Morning Routine Tips", "category": "antiaging", "angle": "ingredient comparison", "key_points": ["L-ascorbic acid vs THD ascorbate vs magnesium ascorbyl phosphate", "Ideal concentration: 10%, 15%, 20% — which works best for your skin", "pH and stability: why packaging matters for vitamin C efficacy", "Vitamin C + sunscreen synergy: the science behind the power couple"]},
            {"title": "Collagen Supplements and Skincare: What the Science Actually Says in 2026", "category": "antiaging", "angle": "evidence-based review", "key_points": ["Hydrolyzed collagen peptides: absorption, bioavailability, clinical data", "Topical collagen vs ingestible collagen: which has better evidence", "Verisol, BioCell, and other patented collagen ingredients compared", "Realistic expectations: what collagen can and cannot do for aging skin"]},
            {"title": "Professional Anti-Aging Treatments Ranked: Microneedling, Laser, Chemical Peels, Botox", "category": "antiaging", "angle": "treatment comparison", "key_points": ["Microneedling: collagen induction, downtime, cost per session, results timeline", "Fractional laser vs IPL: which targets wrinkles, which targets pigmentation", "Chemical peel depths: superficial, medium, deep — recovery and risks", "Neuromodulators (Botox, Dysport): prevention vs correction, cost over time"]},
            {"title": "Antioxidants in Skincare Beyond Vitamin C: Niacinamide, Resveratrol, Ferulic Acid and More", "category": "antiaging", "angle": "multi-ingredient guide", "key_points": ["Niacinamide: pore refinement, barrier support, and the 5% sweet spot", "Resveratrol and ferulic acid: stability, synergistic pairings, clinical evidence", "Green tea EGCG, CoQ10, and astaxanthin: lesser-known antioxidant powerhouses", "How to layer multiple antioxidant serums without overwhelming your skin"]},
            # === Acne Solutions (6 topics) ===
            {"title": "Acne Types Explained: Fungal, Hormonal, Cystic, and Comedonal — How to Treat Each", "category": "acne", "angle": "diagnostic treatment guide", "key_points": ["Fungal acne vs bacterial acne: key identifying features and triggers", "Hormonal acne pattern: chin and jawline, adult women, monthly cycle link", "Cystic vs nodular acne: inflammation depth, scarring risk, treatment urgency", "Closed comedones vs open comedones: extraction safety and prevention"]},
            {"title": "Salicylic Acid vs Benzoyl Peroxide: Which Acne Fighter Is Right for Your Breakouts", "category": "acne", "angle": "ingredient comparison", "key_points": ["Salicylic acid mechanism: oil-soluble exfoliant that unclogs pores from inside", "Benzoyl peroxide mechanism: antibacterial action that kills C. acnes bacteria", "Using both together safely: AM/PM split routine or alternating days", "Concentration guide: 0.5-2% SA, 2.5-10% BP — when more is not better"]},
            {"title": "Diet and Acne Connection: What Foods Trigger Breakouts Based on Current Research", "category": "acne", "angle": "nutrition science review", "key_points": ["High glycemic foods and IGF-1: the insulin-acne pathway explained", "Dairy and acne: whey protein, skim milk, and the hormone hypothesis", "Omega-3 to omega-6 ratio: anti-inflammatory diet for acne reduction", "Zinc, vitamin A, and probiotics: supplements with some clinical support"]},
            {"title": "How to Fade Post-Acne Marks: Hyperpigmentation vs Erythema Treatment Guide", "category": "acne", "angle": "scar and mark treatment", "key_points": ["PIE (post-inflammatory erythema) vs PIH (post-inflammatory hyperpigmentation)", "Tyrosinase inhibitors: tranexamic acid, kojic acid, alpha arbutin, azelaic acid", "Retinoid and chemical exfoliant protocol for cell turnover acceleration", "In-office treatments: vascular laser for PIE, IPL for PIH — cost and sessions"]},
            {"title": "Adult Acne After 25: Why It Happens and Evidence-Based Treatment Strategies", "category": "acne", "angle": "adult-specific guide", "key_points": ["Hormonal triggers: cortisol from stress, menstrual cycle, perimenopause onset", "Skin changes with age: slower cell turnover, thinner barrier, dual anti-aging needs", "Retinoid strategy: adapalene for acne + anti-aging benefits simultaneously", "When to see a dermatologist: prescription options including spironolactone"]},
            {"title": "The Complete Guide to Acne-Friendly Makeup: Ingredients to Avoid and Best Products", "category": "acne", "angle": "product safety guide", "key_points": ["Comedogenic ingredients: what the rating scale means and its limitations", "Non-comedogenic foundation, concealer, and powder recommendations by coverage level", "Application technique: clean brushes, sponge hygiene, and avoiding cross-contamination", "Double cleanse removal: ensuring every trace of makeup is gone before bed"]},
            # === Makeup Tutorials (6 topics) ===
            {"title": "Foundation Matching Guide: How to Find Your Perfect Shade and Formula", "category": "makeup", "angle": "shade matching tutorial", "key_points": ["Undertone identification: cool, warm, neutral, olive — vein test and jewelry test", "Foundation finish types: matte, natural, dewy, satin — which suits your skin type", "How to swatch test correctly: jawline, natural light, oxidation check after 10 minutes", "Coverage levels: sheer, medium, full — building coverage without caking"]},
            {"title": "Eye Makeup for Beginners: Eyeliner, Mascara, and Eyeshadow Step by Step", "category": "makeup", "angle": "beginner eye tutorial", "key_points": ["Eye shape guide: hooded, monolid, almond, round — technique adaptations", "Eyeliner types: pencil, gel, liquid — which is easiest for beginners", "Eyeshadow blending: transition shade, crease definition, lid color placement", "Mascara application: wiggle technique, lower lashes, waterproof vs regular"]},
            {"title": "Contour and Highlight for Every Face Shape: Placement Maps and Blending Tips", "category": "makeup", "angle": "face sculpting guide", "key_points": ["Face shape contour maps: oval, round, square, heart, long — exact placement", "Cream vs powder contour: which works better for dry, oily, and combination skin", "Highlight placement: cheekbones, brow bone, cupid's bow, inner corner — the glow map", "Blending tools: beauty sponge, stippling brush, angled brush — when to use each"]},
            {"title": "5-Minute Everyday Makeup Routine for Work and School", "category": "makeup", "angle": "quick routine tutorial", "key_points": ["Step 1: skin tint or BB cream instead of full foundation for speed", "Step 2: concealer placement for dark circles and spots — triangle method", "Step 3: brows, mascara, and cream blush — the 3 products that change your face", "Step 4: lip tint or balm — low maintenance color that fades gracefully"]},
            {"title": "Special Occasion Makeup: Wedding Guest, Date Night, and Party Looks That Last All Night", "category": "makeup", "angle": "long-wear event guide", "key_points": ["Skin prep: hydration sandwich technique for makeup longevity", "Eye primer and setting spray sandwich: the 12-hour eye makeup method", "False lash application: strip lashes, individual clusters, magnetic — beginner picks", "Touch-up kit essentials: blotting papers, powder, lip color — what to pack"]},
            {"title": "Makeup Brush Guide: Which Brushes You Actually Need and How to Use Each", "category": "makeup", "angle": "tool essentials guide", "key_points": ["The 7 essential brushes: foundation, concealer, powder, blush, eyeshadow (flat + blending), brow", "Natural hair vs synthetic: performance differences and ethical considerations", "Brush cleaning routine: daily spot clean, weekly deep clean — products and technique", "When to replace brushes: shedding, scratchiness, loss of shape — typical lifespan"]},
            # === Product Guides (6 topics) ===
            {"title": "How to Read Skincare Ingredient Labels: INCI Names and What They Mean", "category": "product-guides", "angle": "label literacy guide", "key_points": ["INCI naming system: why ingredients use Latin names and how to recognize them", "Ingredient list order: above 1% line vs below 1% — how to estimate concentration", "Common irritants hiding in plain sight: denatured alcohol, fragrance, essential oils", "Marketing claims vs ingredient reality: 'medical grade,' 'clean,' 'dermatologist tested'"]},
            {"title": "Drugstore vs Luxury Skincare: Which Products Are Worth Splurging On", "category": "product-guides", "angle": "price-value analysis", "key_points": ["Cleansers: why drugstore options are often equal or better than luxury", "Serums: where formulation quality and concentration justify higher prices", "Moisturizers: the mid-range sweet spot — CeraVe to La Roche-Posay to Skinceuticals", "Sunscreen: drugstore Korean and Japanese sunscreens outperform luxury Western brands"]},
            {"title": "Seasonal Skincare Swaps: How to Transition Your Routine for Summer and Winter", "category": "product-guides", "angle": "seasonal routine guide", "key_points": ["Summer switch: lightweight gel moisturizers, higher SPF, oil-control products", "Winter switch: cream cleansers, richer moisturizers, humidifier use, occlusives", "Spring and fall transition: gradual product swapping, patch testing new additions", "Travel-friendly multi-tasking products that work across seasons"]},
            {"title": "Best Skincare Products for Sensitive Skin: Fragrance-Free and Dermatologist-Approved", "category": "product-guides", "angle": "sensitive skin curation", "key_points": ["Fragrance-free vs unscented: the labeling loophole sensitive skin types must know", "Barrier-supporting ingredients: ceramides, cholesterol, fatty acids in the right ratio", "Cleanser, moisturizer, SPF, and treatment picks — all under $30 at drugstores", "Patch testing protocol: how to introduce new products safely in 7 days"]},
            {"title": "Clean Beauty Decoded: Which Ingredients Are Actually Harmful and Which Are Just Marketing", "category": "product-guides", "angle": "myth-busting analysis", "key_points": ["Parabens: the research that sparked the panic and what subsequent studies found", "Sulfates (SLS/SLES): when they're fine and when sensitive skin should avoid them", "Silicones: dimethicone benefits for barrier protection and the 'suffocating skin' myth", "Preservatives: why 'preservative-free' can be more dangerous than well-preserved products"]},
            {"title": "2026 Skincare Gift Guide: Best Sets and Products for Every Budget and Skin Type", "category": "product-guides", "angle": "gift curation guide", "key_points": ["Under $25: effective drugstore gift sets that feel luxurious", "$25-$75: mid-range serums, tools, and discovery sets from trusted brands", "$75-$150: premium devices, LED masks, and professional-grade treatments", "How to choose skincare gifts safely: gift receipts, patch testing, and knowing their routine"]},
        ],
    },
    "sub-auto": {
        "brand": "AutoPulse",
